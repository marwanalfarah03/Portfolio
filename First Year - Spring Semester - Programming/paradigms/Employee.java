...
public class Employee extends People{
	...
	public static void setSalary(String salary) {
		if(People.getRecord()[8][People.getNameCount() - 1] == "Teacher")
		{
			People.setDepartment("Teacher");
		}
		else
		{
			People.setDepartment("Employee");
		}
		People.setRecord(salary, 10, (People.getNameCount() - 1));
		Employee.salary = salary;
	}
	public String getQual() {
		return qual;
	}
	public static void setQual(String qual) {
		People.setRecord(qual, 9, (People.getNameCount() - 1));
		Employee.qual = qual;
	}
		...
		btn4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(!textField1.getText().equals("") && !textField2.getText().equals("") && !textField3.getText().equals("") && !textField4.getText().equals("") && !textField5.getText().equals("") && !textField6.getText().equals("") && !textField7.getText().equals("") && !textField8.getText().equals(""))
				{
					...
					People.setRecord("Teacher", 8, People.getNameCount());
					People.setRecord(textField7.getText(), 9, People.getNameCount());
					People.setRecord(textField8.getText(), 10, People.getNameCount());
					Employee.setQual(textField7.getText());
			...
			public void actionPerformed(ActionEvent e) {
				if(btn3.isEnabled())
				{
					...
					else
					{
						...
						textField8.setText(People.getRecord()[10][People.getNameCount()]);
						btn4.setEnabled(false);
						btn5.setEnabled(true);
					}
				}
